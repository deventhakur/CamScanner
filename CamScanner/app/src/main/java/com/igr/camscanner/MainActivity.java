...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Home
        drawerItems.add(new DrawerItem(menuTitles[0], menuIcons.getResourceId(0, -1), true, "0"));
        // Find People
        drawerItems.add(new DrawerItem(menuTitles[1], menuIcons.getResourceId(1, -1), true, "5"));
        // Photos
